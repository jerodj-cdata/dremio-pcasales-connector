...
@SourceType(value = "PCASalesARP", label = "PCASales",uiConfig = "pcasales-layout.json")
public class PCASalesConf extends AbstractArpConf<PCASalesConf> {
  private static final String ARP_FILENAME = "arp/implementation/pcasales-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.pcasales.PCASalesDriver";
